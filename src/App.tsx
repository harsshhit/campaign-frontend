    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          boxShadow: "0 4px 14px rgba(109, 40, 217, 0.3), 0 0 0 1px rgba(139, 92, 246, 0.3)",
          "&:hover": {
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          ...
          backdropFilter: "blur(20px)",
          boxShadow: "0 10px 30px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(139, 92, 246, 0.1), 0 1px 2px rgba(139, 92, 246, 0.1)",
          transition: "all 0.3s ease-in-out",
          "&:hover": {
            transform: "translateY(-5px)",
            boxShadow: "0 20px 40px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(139, 92, 246, 0.2), 0 1px 3px rgba(139, 92, 246, 0.2)",
...
const GlowingLogo = () => (
  ...
  >
    ...
    <span style={{ background: "linear-gradient(90deg, #3b82f6, #10b981)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>AI</span>
  </Typography>
);
